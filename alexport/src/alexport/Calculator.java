...
public class Calculator extends MenuControl {
	...
	public Calculator () 
	{
		...
		button_0.setBounds(209, 242, 75, 40);
		...
		button_clear.setBackground(Color.DARK_GRAY);
		button_clear.setBounds(327, 85, 75, 40);
		getContentPane().add(button_clear);
		
		JButton btnAlexClanton = new JButton("Alex Clanton");
		btnAlexClanton.setOpaque(true);
		btnAlexClanton.setForeground(Color.BLACK);
		btnAlexClanton.setBorder(new MatteBorder(4, 4, 4, 4, (Color) Color.WHITE));
		btnAlexClanton.setBackground(Color.ORANGE);
		btnAlexClanton.setBounds(35, 242, 104, 40);
		getContentPane().add(btnAlexClanton);
	}
